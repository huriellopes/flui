...
const makeStyles = (c: Palette) =>
  StyleSheet.create({
    ...
    macroLabel: { fontSize: 12, color: c.textMuted, fontWeight: '700', textAlign: 'center' },
    macroValue: { fontSize: 22, fontWeight: '900', marginTop: 4, textAlign: 'center' },
    macroGoal: { fontSize: 11, color: c.textFaint, textAlign: 'center' },
    macroBar: { marginTop: 10, width: '100%' },
