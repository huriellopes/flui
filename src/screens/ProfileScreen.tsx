      ...
      <Card>
        {isLoggedIn ? (
          <View style={s.gap}>
            ...
            <PrimaryButton label="Editar nome, e-mail e senha" onPress={() => setShowEdit(true)} />
...
const makeStyles = (c: Palette) =>
  StyleSheet.create({
    ...
    rowLabel: { fontSize: 15, color: c.textMuted },
    rowValue: { fontSize: 15, color: c.text, fontWeight: '700' },
